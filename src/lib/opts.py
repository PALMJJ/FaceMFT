...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='../exp_mobile/mot/default/model_41epoch.pth',
                             help='path to pretrained model')
    ...
    # model
    self.parser.add_argument('--arch', default='mobilenetv2_10', 
                             help='model architecture. Currently tested'
                                  'resdcn_34 | mobilenetv2_10 | resfpndcn_34 |'
                                  'dla_34 | hrnet_18')
    ...
    self.parser.add_argument('--lr_step', type=str, default='15,30',
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/hengyuli/FaceMFT/dataset')
    ...
    self.parser.add_argument('--id_loss', default='triplet',
    ...
    self.parser.add_argument('--gen_scale',type=bool,default=True,
                            help='Whether to generate multi-scales')
    self.parser.add_argument('--multi_scale',type=bool,default=True,
                            help='Whether to use multi-scale training or not')
    self.parser.add_argument('--input-wh',type=tuple,default=(640, 480),  # (768, 448) or (1088, 608)
  ...
  def parse(self, args=''):
    ...
    opt.exp_dir = os.path.join(opt.root_dir, 'exp_mobile', opt.task)
  ...
  def init(self, args=''):
    ...
    default_dataset_info = {
      'mot': {'default_input_wh': [opt.input_wh[1], opt.input_wh[0]], 'num_classes': 1,
